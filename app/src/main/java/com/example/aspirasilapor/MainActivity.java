...
public class MainActivity extends AppCompatActivity
    ...
    Firebase fb;
    ArrayList<String> lapor = new ArrayList<>();
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fb = new Firebase("https://aspirasistore.firebaseio.com/Lapor");
        lv = (ListView) findViewById(R.id.Listview);

        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, lapor);
